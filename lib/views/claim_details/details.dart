            ...
            child: Column(
              children: [
                ...
                widget.title.toString() == "Allocated"
                    ? FutureBuilder(
                        future: controller.getClaimSearch(
                            status: widget.title.toString().toUpperCase(),
                            searchKey: controller.searchController.value
                                .text), //getClaimSubmitted(status: "ALLOCATED"),
                            ...
                            if (snapshot.hasError) {
                              ...
                              return claimSubmitted.statusCode == 404
                                  ...
                                  : ListView.separated(
                                      ...
                                      itemCount:
                                          claimSubmitted.data!.content!.length,
                                      itemBuilder: (context, index) {
                                        var singleData = claimSubmitted
                                            .data!.content![index];
                                                            ...
                                                            await Clipboard.setData(
                                                              ...
                                                              ScaffoldMessenger
                                                                  ...
                                                                  .showSnackBar(
                                                                      SnackBar(
                                                                          content:
                                                                              Text("copied text ${singleData.punchinClaimId}")));
                                                            });
                ...
                widget.title.toString() == "Action Pending Cases"
                    ? FutureBuilder(
                        future: controller.getClaimSearch(
                            ...
                            searchKey: controller.searchController.value
                                .text), //getClaimSubmitted(status: "ACTION_PENDING"),
                        builder: (context, AsyncSnapshot snapshot) {
                          if (snapshot.connectionState ==
                              ConnectionState.done) {
                            // If we got an error
